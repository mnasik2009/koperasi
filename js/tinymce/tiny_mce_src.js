		...
		function fixInvalidChildren(nodes) {
			...
			for (ni = 0; ni < nodes.length; ni++) {
				...
				if (parent && parents.length > 1) {
					...
					// Check if the element is empty by looking through it's contents and special treatment for <p></p>
					parent = parents[0];
			...
			parser = new tinymce.html.SaxParser({
				...
				start: function(name, attrs, empty) {
					...
					if (elementRule) {
						...
						// Change current node if the element wasn't empty i.e not  or <img />
						if (!empty)
							node = newNode;
				...
				do {
					...
					if (type === 1) {
						...
						if (elements && elements[name]) {
							// Ignore single BR elements in blocks like <p></p> or <p><span></span></p>
							if (name === 'br') {
								brCount++;
								continue;
							}
