...
if(isset($_GET['act']))
{
	...
	$rs=mysql_query("Insert into user_login (`username`,`password`,`login_hash`,`login_gdg`) values ('".$_POST['username']."','".md5($_POST['password'])."','".$_POST['jenis']."','".$_POST['gudang']."')") or die(mysql_error());
	if($rs)
	{
