...
<body>
	...
	<table id="datagrid-crud" title="Outstanding Piutang Report" class="easyui-datagrid" style="width:auto; height: auto;" url="pages/laporan/jsonlap.php" toolbar="#tb" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" collapsible="true">
    <thead>
        <tr>
