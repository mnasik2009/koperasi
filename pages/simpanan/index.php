...
$(function(){
    $('#kode_anggota').combogrid({
				panelWidth:800,
				url: 'pages/simpanan/get_anggota.php?',
...
<body>
	...
	<table id="datagrid-crud" title="Master Simpanan" class="easyui-datagrid" style="width:auto; height: auto;" url="pages/simpanan/json.php" toolbar="#tb" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" collapsible="true">
    <thead>
        <tr>
            ...
            <th data-options="field:'jenis_simpan'">Jenis</th>
            <th data-options="field:'besar_simpanan'" align="right">Jumlah</th>
			<th data-options="field:'tgl_mulai'">Jumlah</th>
			<th data-options="field:'kode_simpan'">ID Simpanan</th>
        </tr>
    </thead>
	</table>
...
<div id="dialog-form" class="easyui-dialog" style="width:500px; height:550px; padding: 10px 20px" closed="true" buttons="#dialog-buttons">
	<form id="form" method="post" novalidate>
		...
		<div class="form-item">
			...
			<input type="text" name="tgl_mulai" id="tgl_mulai" class="easyui-datebox" prompt="Terisi otomatis" required="true" style="width:100%" />
		</div>
		<div class="form-item">
